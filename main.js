const VER = "na-10"; // поменяй строку если GitHub Pages кэшит
...
const DEVICE_PROFILE = (() => {
  ...
  return mobile
    ? {
        ...
        playerScaleMul: 0.25,
        dragonScaleMul: 2.0,
        depth: { topScale: 0.08, midScale: 0.14, bottomScale: 0.25 },
      }
    : {
        mobile: false,
        playerScaleMul: 1.0,
        dragonScaleMul: 1.0,
        depth: { topScale: 1/3, midScale: 0.5, bottomScale: 1.0 },
      };
})();
